...
from summary.integrations import find_obsidian_vaults
from summary.agents.observer import ObserverAgent # Autopilot
from summary.agents.sentinel import SentinelAgent
import re
from summary.pages_ui import (
    render_sentinel, 
    render_autopilot, 
...
def main():
    ...
    if app_mode == "🏠 Home":
        ...
        from summary.batch_summary import render_batch_summary_page
